...
btnFour.addEventListener("click", function () {
  ...
  country.innerHTML = "Timer In Al-Amarat";
  countryImg["src"] = "R (2).jpeg";
});
...
span[2].addEventListener("click", function () {
  ...
  let myFunc = function () {
    ...
    span[6].innerHTML = `${hour} : ${minutes} : ${second}  ${flag}`;
...
span[3].addEventListener("click", function () {
  ...
  let myFunc = function () {
    ...
    span[7].innerHTML = `${hour} : ${minutes} : ${second}  ${flag}`;
